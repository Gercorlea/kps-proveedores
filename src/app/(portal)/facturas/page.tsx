    ...
    <>
      <div className="cr-page-head">
        ...
        <div className="cr-page-head__meta">
          ...
          <br />
          <a className="cr-meta" href="/facturas/nueva">
            Cargar una factura
          </a>
        </div>
      </div>
      ...
      <section className="cr-section">
        <span className="cr-label">Tus facturas</span>
          ...
          <table className="cr-table cr-table--stack">
            <thead>
              <tr>
                ...
                <th>Estatus</th>
                <th>Archivos</th>
                <th className="cr-num">Te pagan</th>
              ...
              {facturas.map((f) => (
                <tr key={f.folio}>
                  ...
                  <td data-label="Estatus">
                    <span className="cr-status" data-tone={TONO_ESTATUS[f.status] ?? undefined}>
                  ...
                  <td data-label="Archivos">
                    ...
                    {' · '}
                    {f.pdfFileKey ? (
                      <a className="cr-code" href={`/api/v1/documents/${f.pdfFileKey}`}>
                        PDF
                      </a>
                    ) : (
                      <span className="cr-muted">sin PDF</span>
                    )}
                  ...
                  <td className="cr-num" data-label="Te pagan">
                    {f.vence ? (
                      fechaCorta(f.vence)
                    ) : (
                      <span className="cr-muted" title="Se calcula cuando KPS registra la factura en Business One">
                        —
                      </span>
                    )}
                  </td>
